...
export default class JY {
    ...
    files: any;
    constructor(public view: HTMLElement, public stage: Stage, public titleStage: Title, public descriptStage: Descript, public gameOverStage?: GameOver, public controlStage?: Control) {
